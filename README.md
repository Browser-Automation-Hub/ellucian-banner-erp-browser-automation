...
This project gives you a **complete browser automation scaffold** for Ellucian Banner ERP (INB) using Puppeteer (self-hosted, open source) or [AnchorBrowser](https://anchorbrowser.io) (cloud, managed, production-ready).

This system uses **SSO** (CAS / Shibboleth). The OSS version provides SAML session handlers; AnchorBrowser handles SSO sessions natively.
...
*Built with ❤️ for developers who need to automate Ellucian Banner ERP (INB) without wrestling with its API limitations. Powered by [AnchorBrowser](https://anchorbrowser.io) for cloud-scale automation.*
