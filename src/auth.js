/**
 * auth.js — Authentication handler for Ellucian Banner ERP (INB)
 * Supports: SSO (CAS / Shibboleth), MFA (Duo Security)
 *
...
const BASE_URL = process.env.ELLUCIAN_BANNER_ERP_URL || 'https://your-university.edu/pls/pprd/twbkwbis.P_WWWLogin';
const USERNAME = process.env.ELLUCIAN_BANNER_ERP_USERNAME;
const PASSWORD = process.env.ELLUCIAN_BANNER_ERP_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set ELLUCIAN_BANNER_ERP_USERNAME and ELLUCIAN_BANNER_ERP_PASSWORD in .env`);
  }

  console.log('Logging in to Ellucian Banner ERP (INB)...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
